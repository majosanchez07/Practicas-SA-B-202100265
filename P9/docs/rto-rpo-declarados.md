...
| Persistente | Volumen de PostgreSQL (`biblioteca`), volumen de RabbitMQ, estado de Terraform | Velero (snapshots EBS + pg_dump) y S3 versionado para el estado |
| Irrecuperable | Llave privada de Sealed Secrets | No se puede regenerar: se guarda una copia en AWS Secrets Manager, fuera del clúster |
